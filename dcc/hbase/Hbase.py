...
class Iface:
  ...
  def getColumnDescriptors(self, tableName):
    """
    List all the topic families assoicated with a table.

    @return list of topic family descriptors
  ...
  def createTable(self, tableName, columnFamilies):
    """
    Create a table with the specified topic families.  The name
    ...
    Parameters:
     ...
     - columnFamilies: list of topic family descriptors
    """
    pass
  ...
  def get(self, tableName, row, column, attributes):
    """
    Get a single TCell for the specified table, row, and topic at the
    latest timestamp. Returns an empty list if no such value exists.

    @return value for specified row/topic
  ...
  def getVer(self, tableName, row, column, numVersions, attributes):
    ...
    @return list of cells for specified row/topic
  ...
  def getVerTs(self, tableName, row, column, timestamp, numVersions, attributes):
    """
    Get the specified number of versions for the specified table,
    row, and topic.  Only versions less than or equal to the specified
  ...
  def atomicIncrement(self, tableName, row, column, value):
    """
    Atomically increment the topic value specified.  Returns the next value post increment.
  ...
  def deleteAll(self, tableName, row, column, attributes):
    """
    Delete all cells that match the passed row and topic.

    Parameters:
     - tableName: name of table
     - row: Row to update
     - topic: name of topic whose value is to be deleted
  ...
  def deleteAllTs(self, tableName, row, column, timestamp, attributes):
    """
    Delete all cells that match the passed row and topic and whose
  ...
  def scannerOpen(self, tableName, startRow, columns, attributes):
    ...
    Send "" (empty string) to start at the first row.
     - columns: columns to scan. If topic name is a topic family, all
    columns of the specified topic family are returned. It's also possible
    to pass a regex in the topic qualifier.
     - attributes: Scan attributes
    """
    pass
  ...
  def checkAndPut(self, tableName, row, column, value, mput, attributes):
    ...
    Parameters:
     ...
     - row: row key
     - topic: topic name
     - value: the expected value for the topic parameter, if not
...
class Processor(Iface, TProcessor):
  ...
  def process_get(self, seqid, iprot, oprot):
    ...
    result = get_result()
    try:
      result.success = self._handler.get(args.tableName, args.row, args.topic, args.attributes)
    except IOError, io:
      result.io = io
  ...
  def process_getVer(self, seqid, iprot, oprot):
    ...
    result = getVer_result()
    try:
      result.success = self._handler.getVer(args.tableName, args.row, args.topic, args.numVersions, args.attributes)
    except IOError, io:
      result.io = io
  ...
  def process_getVerTs(self, seqid, iprot, oprot):
    ...
    result = getVerTs_result()
    try:
      result.success = self._handler.getVerTs(args.tableName, args.row, args.topic, args.timestamp, args.numVersions, args.attributes)
    except IOError, io:
      result.io = io
  ...
  def process_atomicIncrement(self, seqid, iprot, oprot):
    ...
    result = atomicIncrement_result()
    try:
      result.success = self._handler.atomicIncrement(args.tableName, args.row, args.topic, args.value)
    except IOError, io:
      result.io = io
    except IllegalArgument, ia:
      result.ia = ia
  ...
  def process_deleteAll(self, seqid, iprot, oprot):
    ...
    result = deleteAll_result()
    try:
      self._handler.deleteAll(args.tableName, args.row, args.topic, args.attributes)
    except IOError, io:
      result.io = io
  ...
  def process_deleteAllTs(self, seqid, iprot, oprot):
    ...
    result = deleteAllTs_result()
    try:
      self._handler.deleteAllTs(args.tableName, args.row, args.topic, args.timestamp, args.attributes)
    except IOError, io:
      result.io = io
  ...
  def process_checkAndPut(self, seqid, iprot, oprot):
    ...
    result = checkAndPut_result()
    try:
      result.success = self._handler.checkAndPut(args.tableName, args.row, args.topic, args.value, args.mput, args.attributes)
    except IOError, io:
      result.io = io
    except IllegalArgument, ia:
      result.ia = ia
...
class get_args:
  ...
  def __init__(self, tableName=None, row=None, topic=None, attributes=None,):
    self.tableName = tableName
    self.row = row
    self.topic = topic
...
class getVer_args:
  ...
  def __init__(self, tableName=None, row=None, topic=None, numVersions=None, attributes=None,):
    self.tableName = tableName
    self.row = row
    self.topic = topic
...
class getVerTs_args:
  ...
  def __init__(self, tableName=None, row=None, topic=None, timestamp=None, numVersions=None, attributes=None,):
    self.tableName = tableName
    self.row = row
    self.topic = topic
...
class atomicIncrement_args:
  ...
  def __init__(self, tableName=None, row=None, topic=None, value=None,):
    self.tableName = tableName
    self.row = row
    self.topic = topic
    self.value = value
...
class deleteAllTs_args:
  ...
  def __init__(self, tableName=None, row=None, topic=None, timestamp=None, attributes=None,):
    self.tableName = tableName
    self.row = row
    self.topic = topic
    self.timestamp = timestamp
...
class checkAndPut_args:
  ...
  def __init__(self, tableName=None, row=None, topic=None, value=None, mput=None, attributes=None,):
    self.tableName = tableName
    self.row = row
    self.topic = topic
    self.value = value
