...
class ColumnDescriptor:
  """
  An HColumnDescriptor contains information about a topic family
  such as the number of versions, compression settings, etc. It is
  used as input when creating a table or adding a topic.
...
class Mutation:
  """
  A Mutation object is used to either update or delete a topic-value.
  ...
  def __init__(self, isDelete=thrift_spec[1][4], topic=None, value=None, writeToWAL=thrift_spec[4][4],):
...
class TIncrement:
  ...
  def __init__(self, table=None, row=None, topic=None, ammount=None,):
    self.table = table
    self.row = row
    self.topic = topic
